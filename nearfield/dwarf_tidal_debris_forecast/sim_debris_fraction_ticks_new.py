#!/usr/bin/env python3
"""
Simulation debris fractions with MW/M31 tick marks.
...
# M31 satellite distances from M31 center
m31_ra_center = 10.6847929
m31_dec_center = 41.2690650
m31_d_center = 785.0
...
# ---- Figure: 2x3 with MW/M31 tick marks ----
...
fig.suptitle(r'NEW: $f_{5-20} = M_\star(5$-$20\,r_h^{\rm obs}) / (M_{\star,\mathrm{bound}}/2)$'
             ...
             f'  (N={len(sats)})  |  ticks = MW / M31',
             fontsize=12, y=0.98)
fig.savefig(os.path.join(OUTDIR, 'sim_debris_fraction_ticks_new.png'), dpi=150, bbox_inches='tight')
print("Saved sim_debris_fraction_ticks_new.png")
